...
const AppSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar gap-[8rem]">
        <nav className="mb-6">
        ...
        <div>
          <div className="down-container flex-col items-start  gap-6">

            <span className="flex items-start gap-5 p-3 rounded-md bg-[#5E63661A] text-[14px] font-medium"> <ListIcon />  Contact Support</span>

            {/* <div className="sub-down-container flex flex-col items-start gap-5 p-3 menu-item bg-orange-200">
              <span className="flex gap-3 items-center"> <ListIcon /> Free Gift Awaits You! </span>
              <span className="flex items-center  justify-center gap-5 text-xs text-gray-500"> Upgrade Your Account   &gt; </span>
            </div> */}
